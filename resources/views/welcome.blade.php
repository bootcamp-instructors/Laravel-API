...
<!-- 
                                ...
                                <li class="list-group-item">GET <a class="underline"target="_blank" href="http://awesomeincbootcampapi-ianrios529550.codeanyapp.com:3000/public/api/store/cart/1/purchase">/store/cart/{cart_id}/purchase</a></li> -->
                            </ul>
                        </div>
                    </div>
                </div>
