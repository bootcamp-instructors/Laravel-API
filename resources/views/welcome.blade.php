            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        ...
                        <h3 class='text-gray-900 dark:text-white'>Current API Postman Keys</h3>
                        <ul class="list-group text-gray-600 dark:text-gray-400" style="list-style-type:none;">
                            <li class="list-group-item" style="font-size:1em;margin-left:-40px;">Client ID:</li>
                            <li class="list-group-item">94ba363d-e0ab-4649-86ce-4a4392cc00ad</li>
                            <li class="list-group-item" style="font-size:1em;margin-left:-40px;">Client secret:</li>
                            <li class="list-group-item">mYebcUwE5S4FNff4pjK39vx3FtxCmZXz2Hy7XJHZ</li>
                        </ul>
                    </div>
                </div>
            </div>
